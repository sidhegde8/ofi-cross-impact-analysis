...
Step 6: Run the data_preprocessing.py file to preprocess and clean the data
Step 7: Run convert_to_parquet.py file to convert to parquet files (Easier to process data).
